...
@section('breadcrumb')
    ...
    <li class="active"><a href="{{ url('rentalstokmasuk') }}"><i class="fa fa-download"></i>Stok Masuk</a></li>
@endsection
...
@section('content')
    ...
    @include('rental.stockrentins.form')
...
@section('bot')
    ...
    <script type="text/javascript">
        ...
        function editForm(id) {
            ...
            $('#modal-form form')[0].reset();
            $.ajax({
                url: "{{ url('rentalstokmasuk') }}" + '/' + id + "/edit",
                type: "GET",
                dataType: "JSON",
        ...
        $(function(){
            $('#modal-form form').validator().on('submit', function (e) {
                if (!e.isDefaultPrevented()){
                    var id = $('#id').val();
                    if (save_method == 'add') url = "{{ url('rentalstokmasuk') }}";
                    else url = "{{ url('rentalstokmasuk') . '/' }}" + id;
