            ...
            <form  id="form-item" method="post" class="form-horizontal" data-toggle="validator" enctype="multipart/form-data" >
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group col-md-5 col-md-push-2">
                        ...
                        {!! Form::select('warehouse_id', $warehouse2, null, ['class' => 'form-control select', 'placeholder' => '-- Pilih Gudang --', 'id' => 'warehouse_id', 'required']) !!}
                        <span class="help-block with-errors"></span>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="jumlahpindah" name="jumlahpindah" >
                            <span class="help-block with-errors"></span>
                        </div>
