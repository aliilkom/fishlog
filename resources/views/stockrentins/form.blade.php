            ...
            <form  id="form-item" method="post" class="form-horizontal" data-toggle="validator" enctype="multipart/form-data" >
                ...
                <div class="modal-body">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label >Penyewa</label>
                            {!! Form::select('renter_id', $renters, null, ['class' => 'form-control select', 'placeholder' => '-- Choose Renter --', 'id' => 'renter_id', 'required']) !!}
                            <span class="help-block with-errors"></span>
                        ...
                        <div class="form-group">
                            <label >Jumlah</label>
                            <input type="number" class="form-control" id="jumlahsrent" name="jumlahsrent" required>
                            <span class="help-block with-errors"></span>
                        </div>
